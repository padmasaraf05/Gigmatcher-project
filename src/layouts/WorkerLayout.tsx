...
const NAV_ITEMS = [
  ...
  { label: "Jobs",     icon: Search,      path: "/worker/jobs" },
  { label: "Earnings", icon: DollarSign,  path: "/worker/earnings" },
  { label: "Profile",  icon: User,        path: "/worker/profile" },
];

const DRAWER_ITEMS = [
  { label: "Messages",               icon: MessageSquare, path: "/messages" },
  { label: "Availability Settings",  icon: ToggleLeft,    path: "/worker/availability-settings" },
  { label: "Help & Support",         icon: HelpCircle,    path: "/help" },
  { label: "App Settings",           icon: Settings,      path: "/settings" },
  { label: "Notifications",          icon: Bell,          path: "/notifications" },
  { label: "Addresses",              icon: MapPin,        path: "/addresses" },
  { label: "Feedback",               icon: MessageSquare, path: "/worker/feedback" },
];
